...
export const projects: Project[] = [
  {
    ...
    year: "Jun 2026",
    category: "Product",
    body: "Menu bar clipboard history for macOS. Global hotkey, searchable, and pastes straight into whatever app you are using.",
    tags: ["Jun 2026", "Python", "macOS", "Developer Tools", "Open Source"],
    primaryLink: { text: "GitHub", href: "https://github.com/phanisaimunipalli/clipstack" },
    gradient: { from: "#111827", via: "#4b5563", to: "#0b0b0b" },
    isNew: true,
  },
  {
    ...
    year: "May 2026",
    category: "AI",
    body: "Turns your local Claude Code history into a shareable scorecard. Persona, token count, peak hours, and top topics, all generated on your own machine.",
    tags: ["May 2026", "TypeScript", "Next.js", "Claude Code", "Data Viz"],
    primaryLink: { text: "Live", href: "https://claudewrapped.vercel.app" },
    secondaryLink: { text: "GitHub", href: "https://github.com/phanisaimunipalli/claudewrapped" },
    gradient: { from: "#3b0764", via: "#7e22ce", to: "#0b0b0b" },
    isNew: true,
  },
  {
    title: "BrandNamer",
  ...
  },
  {
    ...
    year: "Apr 2026",
    category: "Cloud",
    body: "iOS app for pinning and discovering hyperlocal tips. Restaurants, hidden spots, neighbourhood secrets. Built with SwiftUI, CloudKit, and MapKit. Live on the App Store.",
    tags: ["Apr 2026", "Swift", "SwiftUI", "CloudKit", "MapKit", "iOS"],
    primaryLink: {
      text: "App Store",
      href: "https://apps.apple.com/us/app/knoted-local-secrets-near-me/id6761508441",
    },
    secondaryLink: { text: "Website", href: "https://knoted-web.vercel.app" },
  ...
  },
  {
    ...
    year: "Mar 2026",
    category: "AI",
    body: "Hooks into Claude Code sessions, logs every tool call to JSONL, detects repeated failure patterns, and suggests CLAUDE.md rules that stop them recurring.",
    tags: ["Mar 2026", "Python", "CLI", "Claude Code", "Agents", "Observability"],
    primaryLink: { text: "GitHub", href: "https://github.com/phanisaimunipalli/agentrace" },
    gradient: { from: "#053e2e", via: "#047857", to: "#0b0b0b" },
    isNew: true,
  },
  {
    title: "trender",
    ...
    year: "Mar 2026",
    category: "AI",
    body: "Renders agent output as a live terminal dashboard. Pipe JSON from any AI agent and get tables, charts, and stat cards in your CLI.",
    tags: ["Mar 2026", "Python", "CLI", "Agents", "Data Viz"],
    primaryLink: { text: "GitHub", href: "https://github.com/phanisaimunipalli/trender" },
    gradient: { from: "#7c2d12", via: "#c2410c", to: "#0b0b0b" },
    isNew: true,
  },
  {
    ...
    year: "Mar 2026",
    category: "AI",
    body: "Merged contribution to NVIDIA's OpenClaw plugin. Forced IPv4 DNS resolution on WSL2 to stop bridge processes silently dying seconds after start.",
    tags: ["Mar 2026", "Open Source", "NVIDIA", "Node.js", "WSL2", "Agents"],
    primaryLink: { text: "Merged PR", href: "https://github.com/NVIDIA/NemoClaw/pull/1066" },
    gradient: { from: "#1a3d0a", via: "#76b900", to: "#0b0b0b" },
    isNew: true,
  },
  {
